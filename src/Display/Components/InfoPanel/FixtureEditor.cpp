#include "Display/Components/InfoPanel/FixtureEditor.h"
...
namespace Test
{
    ...
    void FixtureEditor::sync(const Client &client, const std::string &ip, int fixtureId)
    {
    ...
    Element FixtureEditor::render(const Client &client, const std::string &ip, int fixtureId) const
    {
        const auto &fx = client.fixtures[fixtureId];
